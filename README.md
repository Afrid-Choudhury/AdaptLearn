...
8. `20251202023341_fix_security_performance_issues.sql` - Security & performance optimizations
9. `20251202031425_add_sample_assessment_questions.sql` - Sample assessment questions
