  ...
  return (
    <section className="pt-16 md:pt-24 text-center max-w-4xl mx-auto relative">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link
          to="/assessment"
          className="group relative px-8 py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl text-white font-semibold shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:-translate-y-0.5 transition-all duration-200 w-full sm:w-auto flex items-center justify-center gap-2"
        >
        ...
        {!user && (
          <Link
            to="/signup"
            className="px-8 py-3.5 bg-[#1E2332] border border-gray-700 hover:border-gray-500 hover:bg-[#151925] rounded-xl text-gray-200 font-semibold transition-all duration-200 w-full sm:w-auto"
          >
            Create Account
          </Link>
        )}
